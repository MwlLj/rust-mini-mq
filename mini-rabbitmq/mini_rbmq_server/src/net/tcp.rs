...
use super::super::threadpool::mapping;
            ...
            thread::spawn(move || {
                ...
                if let Ok(stream) = stream {
                    ...
                    };
                    {
                        ...
                        pool.execute(&vhost, move || -> CConnect {
                            println!("not found vhost, create connect");
                            ...
                            CTcp::dispatch(
                                conn.consumers.clone(),
                                conn.acks.clone(),
                                conn.queueThreadSet.clone(),
                                threadMax,
                                conn.receiver.clone());
                            conn
                        }, move |connect: &CConnect| {
